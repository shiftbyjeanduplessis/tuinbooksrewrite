...
export function demoWeek(requestedWeekStart?: ScheduleWeek['weekStart']): ScheduleWeek {
  ...
  const dayActions=[{id:'action-demo-note',businessId:'demo',date:addDays(weekStart,1),teamId:'team-1',kind:'team_note' as const,title:'Day instruction',detail:'Collect green bags before first visit.',time:'',status:'active' as const,updatedAt:null},{id:'action-demo-event',businessId:'demo',date:addDays(weekStart,3),teamId:'team-2',kind:'internal_event' as const,title:'Vehicle service',detail:'Workshop stop',time:'11:30',status:'active' as const,updatedAt:null}];
