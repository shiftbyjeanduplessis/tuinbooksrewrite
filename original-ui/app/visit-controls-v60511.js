(() => {
  ...
  const BUILD = '60.5.11-rolling-actions-tasks';
  if (window.__tuinbooksVisitControlsV60511 === BUILD) return;
  window.__tuinbooksVisitControlsV60511 = BUILD;
  ...
  function reconcileScheduleActionRenderersV60511(){
    ...
    try{
      document.querySelectorAll('#weeklyScheduleBoard .schedule-day-lane').forEach(lane=>{
        // v60.3.5/v60.1.0 is the authoritative event renderer. The legacy v60.0.5
        // block may still be produced by app.js underneath it; remove that duplicate
        // DOM so the same ad-hoc event never alternates between two card designs.
        lane.querySelectorAll(':scope .schedule-actions-v6005').forEach(node=>node.remove());
      });
    }catch(_){ }
  }
  function injectStyles() {
    ...
    style.textContent = `
      ...
      /* Clear, semantic office controls. */
      .visit-controls-v6054{color:#24302b!important}
      .visit-controls-v6054 p{color:#59645f!important}
      .visit-controls-actions-v6054 .cancel-no-charge-v60511{background:#fff!important;color:#a8322b!important;border:1.5px solid #c84a41!important;box-shadow:none!important;font-weight:800!important}
      .visit-controls-actions-v6054 .cancel-charge-v60511{background:#b9362f!important;color:#fff!important;border:1.5px solid #b9362f!important;box-shadow:none!important;font-weight:800!important}
      .visit-controls-actions-v6054 .dns-hold-button-v60511{background:#fff6dc!important;color:#6b5200!important;border:1.5px solid #d4af37!important;box-shadow:none!important;font-weight:800!important}
      .visit-controls-actions-v6054 .cancel-no-charge-v60511:hover{background:#fff4f3!important}
      .visit-controls-actions-v6054 .cancel-charge-v60511:hover{background:#9f2d27!important}
      .visit-controls-actions-v6054 .dns-hold-button-v60511:hover{background:#ffefb8!important}

      /* One ad-hoc event renderer only: v6010. Legacy v6005 is suppressed. */
      #weeklyScheduleBoard .schedule-actions-v6005{display:none!important}
      #weeklyScheduleBoard .schedule-actions-v6010{display:grid!important;gap:5px!important;margin:0 0 5px!important}
      #weeklyScheduleBoard .schedule-action-v6010{width:100%!important;display:grid!important;grid-template-columns:auto minmax(0,1fr) auto!important;gap:7px!important;align-items:start!important;padding:7px 8px!important;border-radius:9px!important;font:inherit!important;text-align:left!important}
      #weeklyScheduleBoard .schedule-action-v6010.event{background:#eef7fc!important;border:1px solid #a9cfe2!important;color:#244b63!important}
      #weeklyScheduleBoard .schedule-action-v6010.instruction{background:#fff8dc!important;border:1px solid #e4c960!important;color:#544514!important}
      #weeklyScheduleBoard .schedule-action-v6010>span{font-size:.56rem!important;font-weight:900!important;letter-spacing:.05em!important;white-space:normal!important;line-height:1.15!important}
      #weeklyScheduleBoard .schedule-action-v6010 div{min-width:0!important}
      #weeklyScheduleBoard .schedule-action-v6010 strong{font-size:.69rem!important;line-height:1.18!important;white-space:normal!important;overflow-wrap:anywhere!important}
      #weeklyScheduleBoard .schedule-action-v6010 small{font-size:.58rem!important;line-height:1.2!important;white-space:normal!important;overflow-wrap:anywhere!important;margin-top:2px!important}
      #weeklyScheduleBoard .schedule-action-v6010 time{font-size:.58rem!important;font-weight:850!important;white-space:nowrap!important}
  ...
  function install() {
    ...
    syncRoutineJobTasksFromClientsV60511();
    decorateScheduleCards();
    ...
    if(document.body?.dataset?.app!=='mobile'){
      ...
      if(host){
        ...
        const observer=new MutationObserver(()=>{
          ...
          requestAnimationFrame(()=>{queued=false;syncRoutineJobTasksFromClientsV60511();reconcileScheduleActionRenderersV60511();decorateScheduleCards();});
        });
  ...
  window.__tuinbooksSchedulePolishV60511Test={explicitCadence,inferCadence,clientPattern,targetForWeek,rollingWorkspaceReadyV60511,maintainRollingScheduleV60511,cloudOccurrenceIndexV60511,cloudBlocksOccurrenceV60511,installSingleRollingAuthorityV60511,explicitClientTasksV60511,reconcileScheduleActionRenderersV60511};
