...
(()=>{
  'use strict';
  const BUILD='60.4.16-demo-auto-tour-live-work';
  ...
  window.installTuinBooksDemoShowroomV60416=restoreShowroom;
  window.__tuinbooksDemoShowroomV60416={build:BUILD,restore:restoreShowroom,startTour:()=>renderGuideStep(0),buildState:buildShowroomState,isDemo};
