...
(()=>{
  ...
  function compactControlLabels(){
    ...
    document.querySelectorAll('#view-schedule [data-schedule-drag-scope-v6059]').forEach(btn=>{
      ...
      if(isOn)btn.textContent=btn.dataset.scheduleDragScopeV6059==='future'?'FUTURE':'ONE';
