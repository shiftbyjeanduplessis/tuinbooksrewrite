/* TuinBooks v60.4.2 — Client modal layer fix
...
(()=>{
  'use strict';
  const BUILD='60.4.2-client-modal-layer-fix';
  ...
  function installStyles(){
    if($('clientListModalStylesV6042'))return;
    const style=document.createElement('style');style.id='clientListModalStylesV6042';
    style.textContent=`
  ...
  function markBuild(){
    ...
    if(marker){marker.id='tuinbooksBuildV6042';marker.textContent='v60.4.2';marker.title='Client record modal layer fix · full-width Client list · frozen Schedule remains v60.3.5';}
  }
  ...
  function install(){
    ...
    window.__tuinbooksClientListModalV6042={build:BUILD,listOnlyPage:true,recordSeparateModal:true,paginationRemoved:true,statusDetail:true,frozenScheduleUntouched:true};
  }
