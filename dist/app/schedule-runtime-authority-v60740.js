/* TuinBooks v60.7.40 — Schedule basket runtime repair
...
(()=>{
  ...
  const BUILD='60.7.40-schedule-basket-runtime-repair';
  ...
  function ensureOnboardingSentinel(){
    ...
    if(!button){
      ...
      bar.className='onboarding-import-entry-v60420 tuinbooks-schedule-onboarding-sentinel-v60740';
      bar.hidden=true;
    ...
    if(bar){
      ...
      bar.classList.add('tuinbooks-schedule-onboarding-sentinel-v60740');
    }
    if(button){
      button.tabIndex=-1;
      button.setAttribute('aria-hidden','true');
  ...
  function renderCanonicalBasket({drag=false}={}){
    ...
    // v6007 CSS only displays the drawer while this class is present. Set it
    // before asking the canonical basket renderer to paint its real content.
    document.body?.classList.add('v6007-basket-open');

    try{window.openScheduleQueue?.();}
    catch(error){console.warn('[TuinBooks v60.7.40] open Schedule basket failed',error);}

    // openScheduleQueue normally renders too. Call the exported live binding once
    // more so a stale/late close cannot leave a visible empty shell.
    try{window.renderScheduleQueue?.();}
    catch(error){console.warn('[TuinBooks v60.7.40] render Schedule basket failed',error);}

    const ready=basketRendered(drawer);
    drawer.dataset.v60740Ready=ready?'1':'0';
    if(ready){
      ...
      // Never show the empty bordered placeholder seen in v60.7.39. The observer
      // retries after the current Schedule render has finished.
  ...
  function ensureBasketOpenForRearrange(){
    ...
    document.body?.classList.add('v60740-rearrange-authority');
    const ready=basketRendered(drawer) ? true : renderCanonicalBasket({drag:true});
    if(!ready)return;

    // Rearrange owns the Basket while the mode is active. Keep the real rendered
    // basket in the left column; do not substitute an empty layout placeholder.
    drawer.dataset.v60740Ready='1';
    drawer.classList.remove('hidden','minimised-v58931');
    drawer.removeAttribute('hidden');
    drawer.setAttribute('aria-hidden','false');
    document.body?.classList.add('v6007-basket-open');
  ...
  function openStandardBasket(){
    ...
    const ready=renderCanonicalBasket({drag:false});
    if(!ready){
      setTimeout(()=>renderCanonicalBasket({drag:false}),30);
      setTimeout(()=>renderCanonicalBasket({drag:false}),120);
    }
  }

  function leaveRearrangeLayout(){
    document.body?.classList.remove('v60740-rearrange-authority');
    const drawer=document.getElementById('scheduleParkingLotV5537');
    if(drawer)delete drawer.dataset.v60740Ready;
    const launcher=document.getElementById('scheduleBasketLauncherV58931');
  ...
  function installStyles(){
    ...
    style.textContent=`
      ...
      /* ------------------------------------------------------------
         ...
         ------------------------------------------------------------ */
      body.v60740-rearrange-authority #view-schedule{
        max-width:none!important;
        overflow:visible!important;
      }
      body.v60740-rearrange-authority #view-schedule .schedule-control-room{
      ...
      body.v60740-rearrange-authority #view-schedule .schedule-board-and-parking-v5537{
      ...
      body.v60740-rearrange-authority #weeklyScheduleBoard{
      ...
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-board-scroll{
        width:100%!important;
        min-width:0!important;
        max-width:100%!important;
      ...
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-board-scroll::-webkit-scrollbar{
        display:none!important;
      }
      ...
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-grid-clean{
        display:grid!important;
      ...
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-grid-corner,
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-day-heading,
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-team-heading,
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-day-lane{
        min-width:0!important;
      ...
      body.v60740-rearrange-authority #weeklyScheduleBoard .schedule-card-clean{
        max-width:100%!important;
        min-width:0!important;
      }
      ...
      body.v60740-rearrange-authority #scheduleParkingLotV5537.schedule-basket-panel-v58930,
      body.v60740-rearrange-authority #scheduleParkingLotV5537.schedule-basket-panel-v58930.floating-v58931,
      body.v60740-rearrange-authority #scheduleParkingLotV5537.schedule-basket-panel-v58930.minimised-v58931{
      ...
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-head-v58930{
        flex:0 0 auto!important;
        padding:7px 9px!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-head-v58930 .eyebrow,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-head-v58930 p,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-window-actions-v58931{
        display:none!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-head-v58930 h2{
        margin:0!important;
        font-size:.86rem!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-body-v58931{
        display:flex!important;
      ...
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-drop-hint-v58930{
        padding:4px 6px!important;
        font-size:.58rem!important;
        line-height:1.05!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .control{
        min-height:24px!important;
        padding:3px 6px!important;
        font-size:.59rem!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-groups-v58930,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-group-v58930,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-group-v58930>div{
        gap:2px!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-group-v58930>header{
        min-height:14px!important;
        padding:0 1px!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-group-v58930>header strong{
        font-size:.58rem!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-group-v58930>header small{
        display:none!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .schedule-basket-card-v58930{
        display:grid!important;
      ...
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-main-v58930,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-main-v58930>div:first-child{
        display:block!important;
        min-width:0!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-main-v58930 strong{
        display:block!important;
      ...
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-main-v58930 small,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-main-v58930 p,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-main-v58930 .ui-pill,
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .basket-card-info-v58931{
        display:none!important;
      }
      body.v60740-rearrange-authority #scheduleParkingLotV5537 .queue-work-marker{
        width:12px!important;height:12px!important;min-width:12px!important;font-size:.46rem!important;
      }
      body.v60740-rearrange-authority #scheduleBasketLauncherV58931{
        display:none!important;
      }

      /* Keep drag controls and week controls on one clean row. */
      body.v60740-rearrange-authority #view-schedule .rolling-plan-panel{
        margin-bottom:8px!important;
      }
      body.v60740-rearrange-authority #view-schedule .v6059-schedule-nav{
        width:100%!important;
        min-width:0!important;
      }
      ...
      /* Never render a blank Basket shell in Rearrange mode. */
      body.v60740-rearrange-authority #view-schedule #scheduleParkingLotV5537.schedule-basket-panel-v58930:not([data-v60740-ready="1"]){
        display:none!important;
      }
      body.v60740-rearrange-authority #view-schedule #scheduleParkingLotV5537.schedule-basket-panel-v58930[data-v60740-ready="1"]{
        display:flex!important;
      }
  ...
  function installMarker(){
    ...
    marker.textContent='BUILD v60.7.40';
    marker.title='TuinBooks Schedule basket repair v60.7.40';
  ...
  function installBasketAuthority(){
    ...
    if(typeof base==='function'&&!base.__v60740BasketWrapped){
      const wrapped=function(...args){
        const result=base.apply(this,args);
        setTimeout(queueSync,0);
        return result;
      };
      wrapped.__v60740BasketWrapped=true;
  ...
  window.__TUINBOOKS_RELEASE__='60.7.40';
})();
